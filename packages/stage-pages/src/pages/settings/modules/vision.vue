        ...
        <div>
          ...
          <div :class="['max-w-full', 'mt-2']">
            ...
            >
              ...
              >
                <template #topRight>
                  <div :class="['flex', 'items-center', 'gap-1']">
                    <button
                      type="button"
                      :class="['rounded', 'bg-neutral-100', 'p-1', 'text-neutral-600', 'transition-colors', 'hover:bg-neutral-200', 'dark:bg-neutral-800/60', 'dark:text-neutral-300', 'dark:hover:bg-neutral-700/60']"
                ...
                <template v-if="configuredProviders[metadata.id] === false" #bottomRight>
                  <div
                    :class="['rounded', 'bg-amber-100', 'px-2', 'py-0.5', 'text-xs', 'font-medium', 'text-amber-700', 'dark:bg-amber-900/30', 'dark:text-amber-300']"
                  >
              ...
              <button
                type="button"
                :class="['relative', 'min-w-50', 'w-fit', 'rounded-xl', 'border-2', 'border-neutral-100', 'bg-white', 'p-4', 'transition', 'duration-200', 'ease-in-out', 'hover:border-primary-500/30', 'dark:border-neutral-900', 'dark:bg-neutral-900/20', 'dark:hover:border-primary-400/30', 'flex', 'items-center', 'justify-center']"
            ...
            <div v-else>
              <button
                type="button"
                :class="['flex', 'w-full', 'items-center', 'gap-3', 'rounded-lg', 'border-2', 'border-dashed', 'border-neutral-200', 'bg-neutral-50', 'p-4', 'transition', 'duration-200', 'ease-in-out', 'dark:border-neutral-800', 'dark:bg-neutral-800']"
                @click="showAddDialog = true"
              >
      ...
      <div :class="['flex', 'flex-col', 'gap-4']">
        ...
        <div :class="['mt-2']">
          ...
          <input
            v-model="activeModel"
            type="text"
            :class="['w-full', 'rounded', 'border', 'border-neutral-300', 'bg-white', 'px-3', 'py-2', 'dark:border-neutral-700', 'dark:bg-neutral-900']"
